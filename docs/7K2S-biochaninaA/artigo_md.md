# Dinamica Molecular — Keap1 (dominio Kelch) (PDB 7K2S) + Biochanina A — Secoes do Artigo
...
A estrutura inicial do receptor foi obtida do PDB 7K2S (cadeia A), com os estados
...
interacoes-chave identificadas por analise pos-docking em: Arg470.
...
(Arg470), todas calculadas com ferramentas nativas do GROMACS sobre a
...
- [ ] Avaliar se a persistencia de Arg470 ao longo da producao confirma ou
